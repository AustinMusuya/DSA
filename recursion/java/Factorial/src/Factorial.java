...
public static void inception = () => {
    ...
    inception() //This is the recursive case (function called within the function)
}
...
*/
    ...
    public static void main(String[] args) {
        ...
        System.out.println(findFactorial(35));

        // Recursive Approach:

//        System.out.println(findFactorial2(8));
    ...
    public static int findFactorial2(int number){
        ...
        return findFactorial2(number - 1) * number;
    }
