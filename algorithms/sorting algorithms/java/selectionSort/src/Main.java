...
This ensures that with every outer loop iteration, the smallest remaining element is moved to its correct position.

Unlike insertion sort which *shifts elements*, selection sort *selects* the minimum and swaps just once per pass.
